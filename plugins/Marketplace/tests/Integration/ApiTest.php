...
class ApiTest extends IntegrationTestCase
{
    ...
    {
        $this->service->returnFixture('v2.0_consumer-access_token-not_existing_token.json');
        $this->api->saveLicenseKey('key');
    }
     ...
     * @expectedExceptionMessage Marketplace_ExceptionLinceseKeyIsNotValid
     */
    public function test_saveLicenseKey_shouldThrowException_IfTokenIsExpiredAlongTimeAgo()
    {
    ...
    /**
     * @expectedException \Exception
     * @expectedExceptionMessage Marketplace_ExceptionLinceseKeyIsExpired
     */
    public function test_saveLicenseKey_shouldThrowException_IfTokenIsExpiredRecently()
    {
    ...
    public function test_saveLicenseKey_shouldCallTheApiTheCorrectWay()
    {
        ...
        $this->assertSame('consumer', $this->service->action);
