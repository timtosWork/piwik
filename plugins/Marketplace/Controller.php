...
class Controller extends \Piwik\Plugin\ControllerAdmin
{
    ...
    public function installAllPaidPlugins()
    {
        ...
        if ($hasErrors) {
            $notification = new Notification(Piwik::translate('Marketplace_OnlySomePremiumFeaturesInstalledAndActivated'));
            $notification->context = Notification::CONTEXT_INFO;
        } else {
            $notification = new Notification(Piwik::translate('Marketplace_AllPremiumFeaturesInstalledAndActivated'));
