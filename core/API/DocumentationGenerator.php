...
class DocumentationGenerator
{
    ...
    public function getAllInterfaceString($outputExampleUrls = true, $prefixUrls = '')
    {
        ...
        $str = "<div class='card'><div class=\"card-content\"><h2 id='topApiRef' name='topApiRef'>Quick access to APIs</h2>
				$toc</div></div>
				$str";
    ...
    {
        $str = '';
        $str .= "\n<a name='$moduleName' id='$moduleName'></a><div class='card'><div class=\"card-content\"><h2>Module " . $moduleName . "</h2>";
